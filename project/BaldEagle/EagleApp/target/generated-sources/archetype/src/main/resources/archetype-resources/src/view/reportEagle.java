...
public class reportEagle {
        public static void report() {
            ...
            Scanner scanner_${version} = new Scanner(System.in); //Waits for User Input
            //If data is not a number reask user
            int county_choice = scanner_${version}.nextInt(); //Assigns the user input to a variable 
            ...
            System.out.println("${version}. Baby");
